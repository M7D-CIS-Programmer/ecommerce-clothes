				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item {{ $item->section_id }}">
						...
						<div class="block2">
								<div class="block2-pic hov-img0">
										<img src="{{ asset($item->img) }}" alt="IMG-PRODUCT"  style="max-height: 200px !important;min-height:250px !important">
																...
																<div class="slick3">
																		<div class="wrap-pic-w pos-relative">
																				<div class="product-container">
																						...
																						<a href="#" class="quick-view-btn" id="quick-view-link" data-url="{{ route('product.detail', ':id') }}">
																								Product Details
																						</a>
																				</div>
																		</div>
										...
										<div class="col-md-6 col-lg-5 p-b-30">
												<div class="p-r-50 p-t-5 p-lr-0-lg">
														...
														<div class="container mt-5 d-flex justify-content-center">
															<div class="card shadow-lg border-0 rounded-4 p-4 bg-light" style="max-width: 480px; width: 100%;">
																	...
																	<form id="addToCartForm" action="{{ route('shopping.cart',1) }}" method="GET">
																			...
																			<div class="mb-3">
																					...
																					<div class="d-flex justify-content-between align-items-center border rounded-pill p-2 shadow-sm bg-white">
																							<button class="btn btn-sm btn-outline-danger fw-bold rounded-circle" type="button" id="decrease">−</button>
																							<input class="form-control text-center border-0 fw-bold" type="number" name="quantity" value="1" min="1" id="quantity" style="max-width: 50px;">
																							<button class="btn btn-sm btn-outline-success fw-bold rounded-circle" type="button" id="increase">+</button>
																					</div>
																			</div>
