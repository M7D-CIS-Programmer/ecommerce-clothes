                                    ...
                                    <tr class="table_row">
                                        <td class="column-1">
                                            <div class="how-itemcart1">
												<a href="{{ route('Cart.delete',$item->id)}}"><img src="{{ asset($item->img) }}" alt="IMG-PRODUCT"></a>
											</div>
                                        </td>
                                        ...
                                        <td class="column-4">
                                            <div class="wrap-num-product flex-w m-l-auto m-r-0">
                                                ...
                                                <input class="mtext-104 cl3 txt-center num-product" type="number"
                                                    name="quantity[]" value="{{ $quantity[$key] }}">
                                        ...
                                        <td class="column-5">$ {{ $TotalOfProduct[$key] }}</td>
                                    </tr>
                                @endforeach
                        ...
                        <div class="flex-w flex-t bor12 p-t-15 p-b-30">
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                ...
                                <div class="p-t-15">
                                    ...
                                    <form action="{{ route('Cart.Check') }}" method="GET">
                                        @csrf
                                        <div class="rs1-select2 rs2-select2 bor8 bg0 m-b-12 m-t-9">
                                        ...
                                        <div class="bor8 bg0 m-b-22">
                                            <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="tel" name="phone" id="phone" placeholder="Phone" required>
                                        </div>
